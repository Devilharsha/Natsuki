...
buttons = [
    [
        InlineKeyboardButton(
            text="blaze News 🙋‍♂️", url="https://t.me/THE_BLAZE_NETWORK"
        ),
        InlineKeyboardButton(
            text="Support Group 💬", url="https://t.me/BLAZE_SUPPORT"
        ),
    ],
    [
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
            ...
            url="t.me/the_blaze_probot?startgroup=true",
        ),
    ],
]
